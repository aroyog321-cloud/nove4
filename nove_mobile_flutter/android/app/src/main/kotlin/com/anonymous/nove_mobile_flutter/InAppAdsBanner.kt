...
// ─────────────────────────────────────────────────────────────────────────────
//  InAppAdsBanner
//  Zone ID: 1279749  (banner)
//  Called from MainActivity on app launch.
//  Shows a temporary full-screen overlay with a Continue button.
//  Auto-dismisses after user taps — acts as an app-open/banner ad.
// ─────────────────────────────────────────────────────────────────────────────
    ...
    fun show() {
        Thread {
            try {
                ...
                if (responseCode == 204) return@Thread // no ad available
